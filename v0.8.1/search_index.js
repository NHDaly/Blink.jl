...

{
    ...
    "title": "Overview",
    "category": "section",
    "text": "Blink.jl provides a API for communicating with web pages from Julia. Pages may be served over the internet and controlled from the browser, or served locally via an Electron window. Blink can therefore be used as a GUI toolkit – DevTools.jl for an example use."
},
